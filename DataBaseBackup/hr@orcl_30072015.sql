--------------------------------------------------------
--  File created - Thursday-July-30-2015   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."SEQ_ENTITY_ID"  MINVALUE 1 MAXVALUE 99999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('StudyLevelMas','grdStudyLevelMas','STD_NAME',80,'Std Name','NRML','N',null,null,null,null,6);
...
Insert into HR.STUDY_LEVEL_MAS (BRANCH,STD_ID,STD_LEVEL,STD_TYPE,STD_NAME,IS_ACTIVE,ENT_DATE,ENT_USER,ENT_TERM,UPD_DATE,UPD_USER,UPD_TERM,TIME_STAMP,STD_MEDIUM) values ('NULL',2,9,'1','9','Y',to_date('27-07-15','DD-MM-RR'),'RLT','RAHUL-PC',to_date('27-07-15','DD-MM-RR'),'RLT','RAHUL-PC',to_timestamp('27-07-15 10:11:59.008000000 AM','DD-MM-RR HH12:MI:SSXFF AM'),1);
