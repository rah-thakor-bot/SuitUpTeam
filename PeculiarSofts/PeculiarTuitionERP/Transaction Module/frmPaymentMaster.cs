...
namespace PeculiarTuitionERP.Transaction_Module
{
    public partial class frmPaymentMaster : frmBaseChild
    {
        ...
        private void UpdateControlBehaviour()
        {
            ...
            switch (strBtnActionType.ToUpper())
            {
                ...
                case "ADD":
                    ...
                    grdPaymentMas.Focus();
                    grdPaymentMas.CurrentCell = grdPaymentMas.Rows[grdPaymentMas.Rows.Count - 1].Cells["STD_ID"];
                    SetAutoIncrement();
                    break;
                case "EDIT":
                    grdPaymentMas.AllowUserToAddRows = true;
                ...
                case "SEARCH":
                    ...
                    grdPaymentMas.AllowUserToAddRows = true;
                    grdPaymentMas.CurrentCell = grdPaymentMas.Rows[0].Cells["STD_ID"];
                    grdPaymentMas.Rows[0].Cells["STD_ID"].Value = DBNull.Value;
                    grdPaymentMas.Focus();
                    grdPaymentMas.ReadOnly = false;
                    break;
                case "REFRESH":
        ...
        private void SetAutoIncrement()
        {
            ...
            {
                _dtPaymentMas.Columns["STD_ID"].AutoIncrement = true;
                _dtPaymentMas.Columns["STD_ID"].AutoIncrementSeed = -1;
                _dtPaymentMas.Columns["STD_ID"].AutoIncrementStep = -1;
            }
        }
