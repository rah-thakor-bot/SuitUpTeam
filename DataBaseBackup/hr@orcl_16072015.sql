...
SET DEFINE OFF;
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('EntityTypeMas','grdMas','ENTITY_TYPE_ID',40,'Seqno','NRML','N',null,null,null,null,3);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('EntityTypeMas','grdMas','ENTITY_TYPE_NAME',40,'Type Name','NRML','N',null,null,null,null,2);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('EntityTypeMas','grdMas','IS_ACTIVE',25,'Is Active','CHKBX','N',null,null,null,null,1);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','BRANCH_ID',45,'Branch Name','NRML','N',null,null,null,null,1);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','REF_STD_ID',40,'Standard','CMBBX','ACTSTD',null,null,null,null,2);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','SUB_ID',30,'Subject ID','NRML','N',null,null,null,null,3);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','SUB_NAME',50,'Subject Name','NRML','N',null,null,null,null,4);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','HAVE_EXAM',45,'Have Exam','CHKBX','N',null,null,null,null,5);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','IS_ACTIVE',25,'Is Active','CHKBX','N',null,null,null,null,6);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','ENT_DATE',40,'Ent Date','HIDECOL','N',null,null,null,null,7);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','ENT_USER',40,'Ent User','HIDECOL','N',null,null,null,null,8);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','ENT_TERM',40,'Ent Term','HIDECOL','N',null,null,null,null,9);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','UPD_DATE',40,'Upd Date','HIDECOL','N',null,null,null,null,10);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','UPD_USER',40,'Upd User','HIDECOL','N',null,null,null,null,11);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','UPD_TERM',40,'Upd Term','HIDECOL','N',null,null,null,null,12);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdMas','TIME_STAMP',40,'TimeStamp','HIDECOL','N',null,null,null,null,13);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."STUDY_LEVEL_MAS" MODIFY ("BRANCH_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  /* TODO enter package declarations (types, exceptions, methods etc) here */ 
type ref_cur is REF CURSOR;
procedure prc_mas_ins(p_branch_id  STUDY_LEVEL_MAS.BRANCH_ID%type,
...
procedure prc_mas_upd(p_branch_id  STUDY_LEVEL_MAS.BRANCH_ID%type,
                      p_std_id STUDY_LEVEL_MAS.STD_ID%type,
                      p_std_level STUDY_LEVEL_MAS.STD_LEVEL%type,
                      p_std_type STUDY_LEVEL_MAS.STD_TYPE%type,
                      p_std_name STUDY_LEVEL_MAS.STD_NAME%type,
...
procedure prc_mas_del(p_branch_id STUDY_LEVEL_MAS.BRANCH_ID%type,
                      p_std_id STUDY_LEVEL_MAS.STD_ID%type,
                      p_flg out varchar2,
                      p_msg out varchar2
                     );
...
/
--------------------------------------------------------
--  DDL for Package PKG_TUTIION_BASE
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE "HR"."PKG_TUTIION_BASE" AS 

type ref_cur is ref cursor;

procedure prc_fetch_grid_fields(p_menu_name varchar2,p_ctrl_name varchar2,p_data out ref_cur);

END PKG_TUTIION_BASE;
  ...
  BEGIN
    ...
    begin
        INSERT INTO STUDY_LEVEL_MAS
                  (
                    BRANCH_ID,  STD_ID,   STD_LEVEL,
                    STD_TYPE,   STD_NAME, IS_ACTIVE,
                    ENT_DATE,   ENT_USER, ENT_TERM,
                    TIME_STAMP
                  )
                  VALUES
                  (p_branch_id, p_std_id,   p_std_level,
...
/
--------------------------------------------------------
--  DDL for Package Body PKG_TUTIION_BASE
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "HR"."PKG_TUTIION_BASE" AS

  procedure prc_fetch_grid_fields(p_menu_name varchar2,p_ctrl_name varchar2,p_data out ref_cur) AS
  BEGIN
    -- TODO: Implementation required for procedure PKG_TUTIION_BASE.prc_fetch_grid_fields
    open p_data for 
    select * from GRID_FIEDLS a
     where a.MENU_NAME =  p_menu_name
       and a.CTRL_NAME = p_ctrl_name;
    exception when others then
