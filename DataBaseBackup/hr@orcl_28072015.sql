--------------------------------------------------------
--  File created - Tuesday-July-28-2015   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into HR.BATCH_MAS (BRANCH,BATCH_ID,BATCH_NAME,REF_SUB_ID,REF_T_ENTITY_ID,FR_TIME,TO_TIME,ENT_DATE,ENT_TERM,ENT_USER,UPD_DATE,UPD_USER,UPD_TERM,TIME_STAMP) values ('NULL',1,'TEST01',null,null,800,930,to_date('28-07-15','DD-MM-RR'),'RAHUL-PC','RLT',null,null,null,to_timestamp('28-07-15 02:23:27.503000000 AM','DD-MM-RR HH12:MI:SSXFF AM'));
