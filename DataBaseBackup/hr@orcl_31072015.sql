...
SET DEFINE OFF;
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('EntityTypeMas','grdMas','ENTITY_TYPE_ID',60,'Seqno','NRML','N',null,null,null,null,1);
...
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('EntityTypeMas','grdMas','IS_ACTIVE',60,'Is Active','CHKBX','N',null,null,null,null,3);
...
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('StudyLevelMas','grdStudyLevelMas','STD_ID',60,'Std ID','READONLY','N',null,null,null,null,2);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('StudyLevelMas','grdStudyLevelMas','STD_MEDIUM',80,'Std Medium','CMBBX','STDMED',null,null,null,null,3);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('StudyLevelMas','grdStudyLevelMas','STD_LEVEL',80,'Standard ','NRML','N',null,null,null,null,5);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('StudyLevelMas','grdStudyLevelMas','STD_TYPE',80,'Std Type','CMBBX','STDTYPE',null,null,null,null,4);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('StudyLevelMas','grdStudyLevelMas','STD_NAME',80,'Std Name','REQUIRED','N',null,null,null,null,6);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('StudyLevelMas','grdStudyLevelMas','IS_ACTIVE',80,'Is Active','CHKBX','N',null,null,null,null,7);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('StudyLevelMas','grdStudyLevelMas','TIME_STAMP',80,'Timstamp','HIDECOL','N',null,null,null,null,8);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdSubjectMaster','BRANCH',60,'Branch Name','HIDECOL,READONLY','N',null,null,null,null,1);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdSubjectMaster','REF_STD_ID',60,'Standard','CMBBX','ACTSTD',null,null,null,null,2);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdSubjectMaster','SUB_ID',60,'Subject ID','NRML','N',null,null,null,null,3);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdSubjectMaster','SUB_NAME',60,'Subject Name','NRML','N',null,null,null,null,4);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdSubjectMaster','HAVE_EXAM',60,'Have Exam','CHKBX','N',null,null,null,null,5);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdSubjectMaster','IS_ACTIVE',60,'Is Active','CHKBX','N',null,null,null,null,6);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('BatchMaster','grdBatchMaster','BRANCH',60,'Branch Name','HIDECOL,','N',null,null,null,null,1);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('BatchMaster','grdBatchMaster','BATCH_ID',60,'Batch ID','READONLY','N',null,null,null,null,2);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('BatchMaster','grdBatchMaster','BATCH_NAME',60,'Batch Name','NRML','N',null,null,null,null,3);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('BatchMaster','grdBatchMaster','REF_SUB_ID',60,'Subject Name','CMBBX','ACTSUB',null,null,null,null,4);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('BatchMaster','grdBatchMaster','REF_T_ENTITY_ID',60,'Teacher','CMBBX','TEACHER',null,null,null,null,5);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('BatchMaster','grdBatchMaster','FR_TIME',60,'From Time','NRML','N',null,null,null,null,6);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdSubjectMaster','TIME_STAMP',60,'TimeStamp','HIDECOL','N',null,null,null,null,7);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdChapterDetail','SEQNO',60,'Seqno','NRML,READONLY','N',null,null,null,null,1);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdChapterDetail','REF_SUB_ID',60,'Subject ID','NRML','N',null,null,null,null,2);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdChapterDetail','CHP_ID',60,'Chapter No','NRML','N',null,null,null,null,3);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdChapterDetail','CHP_NAME',60,'Chapter Name','NRML','N',null,null,null,null,4);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdChapterDetail','DESCRIPTION',60,'Description','NRML','N',null,null,null,null,5);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdChapterDetail','REMARK',60,'Remark','NRML','N',null,null,null,null,6);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('SubjectMas','grdChapterDetail','TIME_STAMP',60,'Timestamp','HIDECOL,READONLY','N',null,null,null,null,7);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('BatchMaster','grdBatchMaster','TO_TIME',60,'To Time','NRML','N',null,null,null,null,7);
Insert into HR.GRID_FIEDLS (MENU_NAME,CTRL_NAME,DATA_FIELD_NAME,FIELD_SIZE,DISP_NAME,COL_TYPE,COMBO_FLG,COMBO_BIND_ID,EXCEL_FIELD_NAME,REMARK,EXTRA_REMARK,ORD) values ('BatchMaster','grdBatchMaster','TIME_STAMP',60,'TimeStamp','READONLY,HIDECOL','N',null,null,null,null,8);
...
--------------------------------------------------------
  ...
  procedure prc_mas_ins(  p_branch       exam_mas.branch%type,
                          ...
                          p_ent_date exam_mas.ent_date%type,
   ...
   procedure prc_mas_upd(
                          ...
                          p_upd_date exam_mas.ent_date%type,
    ...
    begin
        ...
        values
          (p_branch,     p_batch_id,     p_exam_id,
           ...
           p_ent_date,   p_ent_term,     p_ent_user,
           p_time_stamp);
...
begin
     update exam_mas
        set branch = p_branch,
            batch_id = p_batch_id,
            ref_sub_id = p_ref_sub_id,
            total_mark = p_total_mark,
            exam_type = p_exam_type,
            type_det = p_type_det,
            paper_set_by = p_paper_set_by,
...
AS
  ...
  BEGIN
    ...
    OPEN p_data FOR SELECT a.MENU_NAME , a.CTRL_NAME , a.DATA_FIELD_NAME , a.FIELD_SIZE , a.DISP_NAME , a.COL_TYPE , a.COMBO_FLG , a.COMBO_BIND_ID , a.EXCEL_FIELD_NAME , a.REMARK , a.EXTRA_REMARK , a.ORD FROM GRID_FIEDLS a WHERE a.MENU_NAME = p_menu_name AND a.CTRL_NAME = nvl(p_ctrl_name,a.CTRL_NAME);
  EXCEPTION
  WHEN OTHERS THEN
