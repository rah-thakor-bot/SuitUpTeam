    ...
    public class MaterialSkinManager
    {
        ...
        private void UpdateToolStrip(ToolStrip toolStrip, Color newBackColor)
        {
            ...
            foreach (ToolStripItem control in toolStrip.Items)
            {
                ...
                if (control is ToolStripMenuItem && (control as ToolStripMenuItem).HasDropDownItems)
                {
                    //recursive call
                    UpdateToolStrip((control as ToolStripMenuItem).DropDown, newBackColor);
                }
            }
        }
        ...
        private void UpdateControl(Control controlToUpdate, Color newBackColor)
        {
            ...
            var tabControl = controlToUpdate as TabControl;
            if (tabControl != null)
            {
